...
StringRef COFFObjectFile::getRelocationTypeName(uint16_t Type) const {
  ...
  case Triple::riscv64:
    switch (Type) {
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_ABSOLUTE);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_ADDR32);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_ADDR64);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_ADDR32NB);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_SECTION);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_SECREL);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_PCREL_HI20);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_PCREL_LO12_I);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_PCREL_LO12_S);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_JAL);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_BRANCH);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_RVC_JUMP);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_RVC_BRANCH);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_CALL);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_REL32);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_SECREL_HI20);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV64_SECREL_LO12_I);
    default:
      return "Unknown";
    }
    break;
